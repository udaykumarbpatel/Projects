...
public class Flights implements Serializable {
	...
	public Flights selectFlight(String operator, String number, String dot) {
		String SQL = "SELECT * FROM FLIGHTS WHERE FLIGHTS.OPERATOR = " + "'"
				+ operator + "'" + " AND FLIGHTS.FLIGHTNUMBER = '" + number
				+ "'" + " AND FLIGHTS.DATEOFTRAVEL = '" + dot
				+ "'";
		Flights flight = new Flights();
		try {
			ResultSet rs = d.execute(SQL);
	...
	public Flights getAvailableSeats(String flightnumber, String operator, String dot) {
		String SQL = "SELECT * FROM FLIGHTS WHERE FLIGHTS.OPERATOR = " + "'"
				+ operator + "'" + " AND FLIGHTS.FLIGHTNUMBER = '"
				+ flightnumber + "'" + " AND FLIGHTS.DATEOFTRAVEL = '"
						+ dot + "'";
		Flights flight = new Flights();
		try {
			ResultSet rs = d.execute(SQL);
	...
	public void updateSeats(String flightnumber, String operator, int seats, String dot) {
