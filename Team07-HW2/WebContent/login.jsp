...
body {
	font-size: 90.5%;
	background-image:url('http://www.freevector.com/site_media/preview_images/FreeVector-Travel-Graphics.jpg');
			...
			<table width="330" border="3" align="center"
				...
				<tr>
					<td colspan="2"><span class="style5"><a
							href="register.jsp">New User?</a></span> <input type="checkbox"
						name="remember" id="remember" value="remember" />Remember
							me!!!<br /></td>
