...
public class Terminal {
	 ...
	 * 
	 * @param fn
	 *            string to call transcript file
	 * @return none
	 */
	...
	public static void startTranscript(String fn) {
		...
		try {
			...
			outFile.println("----- Transcript file " + fileName + " started "
					+ new Date());
			System.out
					.println("----- Writing output to the file: " + fn + ". ");
		} catch (IOException e) {
	...
	/**
	 * Print a string to the command line with a carriage return. <br>
	...
	/**
	 * Print procedure call information to the command line with a <br>
	 * carriage return. Indentation is increased for future println <br>
	 * and indent calls.
	 * 
	 * @param s
	 *            procedure call information to output
	 * @return none
	 */
	...
	/**
	 * Print a return value to the command line with a <br>
	 * carriage return. Indentation is decreased for future println <br>
	 * and indent calls.
	 * 
	 * @param s
	 *            string (the formatted return value) to output
	 * @return none
	 */
